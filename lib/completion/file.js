...
module.exports = {
    ...
    save_tmp_file_for_completion_list_of_instance_type: function(type, key_path, imports) {
            // Setup
        var key_path_str;
        var import_str = '';
        ...
        if (imports != null && imports.length > 0) {
            for (var i = 0; i < imports.length; i++) {
                import_str += 'import ' + imports[i] + '; ';
            }
        }

        var file_contents = import_str + 'class AtomHaxeTempClass__ { public static function main():Void { var atomHaxeTempVar__:' + type + '; atomHaxeTempVar__.' + key_path_str;
        ...
        // Save file to get completion list of package (to list sub-packages).
    save_tmp_file_for_completion_list_of_package: function(package_name) {

            // Setup
        var file_contents = 'import ' + package_name + '.';
        var file_name = 'AtomHaxeTempImport__.hx';
