...
var commands_SetHXMLFile = function(params) {
	utils_Command.call(this,params);
};
$hxClasses["commands.SetHXMLFile"] = commands_SetHXMLFile;
commands_SetHXMLFile.__name__ = ["commands","SetHXMLFile"];
commands_SetHXMLFile.__super__ = utils_Command;
commands_SetHXMLFile.prototype = $extend(utils_Command.prototype,{
	execute: function(resolve,reject) {
	...
	,__class__: commands_SetHXMLFile
});
...
state_State.synchronize = function() {
	...
	state_State.get_other_worker().run_command(new commands_SynchronizeState({ values : values}));
};
