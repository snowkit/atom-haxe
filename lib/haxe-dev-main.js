...
HaxeDevMain.activate = function(state) {
	...
	console.log(platform_atom_Log.format("Starting HaxeDev worker..."));
...
var state_base_MainState = function() { };
$hxClasses["state.base.MainState"] = state_base_MainState;
state_base_MainState.__name__ = ["state","base","MainState"];
...
state_State.__super__ = state_base_MainState;
state_State.prototype = $extend(state_base_MainState.prototype,{
...
tasks_SetHXMLFile.prototype = $extend(utils_WorkerTask.prototype,{
	run: function(resolve,reject) {
		console.log(platform_atom_Log.format("Set HXML File to " + this.params.path));
